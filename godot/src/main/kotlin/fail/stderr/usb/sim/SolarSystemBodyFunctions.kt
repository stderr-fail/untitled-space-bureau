...
//  val integrator = HighamHall54Integrator(settings.minStep, settings.maxStep, tolerances[0], tolerances[1])
//  val integrator = DormandPrince54Integrator(settings.minStep, settings.maxStep, tolerances[0], tolerances[1])
//  val integrator = GraggBulirschStoerIntegrator(settings.minStep, settings.maxStep, tolerances[0], tolerances[1])
